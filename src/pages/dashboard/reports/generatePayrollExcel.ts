...
export function generatePayrollExcel(
  ...
  const allAdditionals = data.flatMap(d => d.additionalEntries || []).sort((a, b) => new Date(a.date.split("T")[0] + "T12:00:00").getTime() - new Date(b.date.split("T")[0] + "T12:00:00").getTime());
